...
Define the authenticated Categories screen behavior for product and recipe category listing, creation, editing, deletion, and current docs archive handling.
